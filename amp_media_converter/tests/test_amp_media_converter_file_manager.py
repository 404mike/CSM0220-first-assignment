...
class Test_AMP_Media_Converter_File_Manager(unittest.TestCase):
    ...
    def __init__(self, *args, **kwargs):
        super(
            Test_AMP_Media_Converter_File_Manager,
            self).__init__(
            *args,
            **kwargs)
    ...
    def test_jpg_list_directory_media(self):
        ...
        expected_list = [
            ...
            'adorable-animal-breed-canine-374906.jpg',
            'close-up-of-dog-yawning-248307.jpg',
            'animal-dog-pet-cute-2007.jpg',
            'adult-tan-and-white-french-bulldog-545063.jpg',
            'english-cocker-spaniel-puppy-sitting-on-ground-beside-grass-1254140.jpg',
            'close-up-photography-of-fawn-pug-covered-with-brown-cloth-374898.jpg']
    ...
    def test_multi_content_list_directory_media(self):
        ...
        expected_list = [
            ...
            'adorable-blur-breed-close-up-406014.png',
            'black-and-brown-rottweiler-puppy-1307630.png',
            'animal-dog-puppy-pug-59523.jpg',
            'adorable-animal-breed-canine-374906.jpg',
            'close-up-of-dog-yawning-248307.jpg',
            'animal-dog-pet-cute-2007.jpg',
            'adult-tan-and-white-french-bulldog-545063.jpg',
            'adult-black-pug-1851164.png',
            'english-cocker-spaniel-puppy-sitting-on-ground-beside-grass-1254140.jpg',
            'close-up-photography-of-fawn-pug-covered-with-brown-cloth-374898.jpg']
